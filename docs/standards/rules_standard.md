...
- **Regras de qualidade** — critérios mínimos que uma saída deve satisfazer antes de ser entregue (ex.: aplicar os critérios de requisito bem escrito da ISO 29148 antes de finalizar um requisito funcional, ver `../../knowledge/methodology/iso29148.md`).
