...
def _texto_para_storage(texto: str) -> str:
    ...
    Usado para publicar artefatos (PRD, visão, estratégia) produzidos pelos
    formatadores deste agente, sempre Markdown. Cobre só o que esses
    formatadores efetivamente geram — não é um conversor Markdown genérico.
    """
    partes: list[str] = []
