...
from aqua_qe_product_manager.skills.validate_prd import validate_prd
...
def test_missing_context_problem_fails():
    assert validate_prd(_draft(context_problem="")) is False
