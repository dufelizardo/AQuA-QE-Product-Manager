from aqua_qe_product_manager.skills import create_confluence_page as module
...
def test_create_confluence_page_delegates_to_service_and_returns_url(monkeypatch):
    ...
    resultado = module.create_confluence_page("# PRD\n\nobjetivo do produto", "PRD gerado")
