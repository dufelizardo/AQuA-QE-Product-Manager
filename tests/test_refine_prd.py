...
from aqua_qe_product_manager.skills import refine_prd as module
...
def test_refine_prd_prompt_instrui_a_preservar_detalhe_de_campos_nao_perguntados(monkeypatch):
    ...
    tende a simplificar/encurtar campos que não têm relação com as respostas daquela rodada."""
    captured = {}
